...
public class CircularProgress: UIView, CAAnimationDelegate {
    ...
    public var progress: Double {
        ...
        set {
            angle = newValue.clamp(lowerBound: 0.0, upperBound: 1.0) * 360.0
        }
    }
    ...
    public override func layoutSubviews() {
        ...
        progressLabel.font = UIFont.systemFont(ofSize: radius * 0.3) // Adjust font size based on radius
    }
    ...
    private func setupLabel() {
            ...
            NSLayoutConstraint.activate([
                ...
                progressLabel.centerYAnchor.constraint(equalTo: centerYAnchor, constant: -(progressLabel.frame.height + 2.5))
            ])
        }
    ...
    private func setInitialValues() {
        ...
        progressLabel.text = "0%"
            ...
            progressLabel.font = UIFont.systemFont(ofSize: 14, weight: .bold)
        ...
        private func updateLabel() {
            ...
            progressLabel.center = CGPoint(x: bounds.size.width / 2.0, y: bounds.size.height / 2.0)
        }
    ...
    public func animate(fromAngle: Double, toAngle: Double, duration: TimeInterval, relativeDuration: Bool = true, completion: ((Bool) -> Void)?) {
            ...
            // Animate label text
            animateLabelText(from: 0, to: 100, duration: animationDuration)
        }
    ...
    private func animateLabelText(from startValue: Double, to endValue: Double, duration: TimeInterval) {
        let startTime = Date()
        ...
        Timer.scheduledTimer(withTimeInterval: 0.1, repeats: true) { timer in
            ...
            self.progressLabel.text = "\(Int(currentValue))%"
            
            if progress >= 1.0 {
                timer.invalidate()
                self.progressLabel.text = "\(Int(endValue))%" // Ensure final value is set
            }
        }
    }
